# Generated by Django 5.1.7 on 2025-04-20 12:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favourite_artists', models.ManyToManyField(blank=True, related_name='favourite_artists', to='api.artist')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='favourite_tracks', to='api.track'),
        ),
    ]
